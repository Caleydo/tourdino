import { SCOPE } from '../base/interfaces';
import * as d3 from 'd3';
import 'd3.parsets/d3.parsets';
import { BaseUtils } from '../base/BaseUtils';
export class ParallelSets {
    formatData(setParameters, isAttr) {
    ...
    formatDataSelectionAgainstCatOrGroup(setParameters, dimension1, dimension2) {
        ...
        if (pSDOtherCategory.value > 0) {
            data.push(pSDOtherCategory);
        }
        return data;
    }
    formatDataAttribute(setParameters, dimension1, dimension2) {
    ...
    generateVisualization(miniVisualisation, setParameters, score) {
        ...
        const formatData = this.formatData(setParameters, isAttr);
    ...
    highlightAndColorRibbons(setParameters, svgRibbons, dimensionName) {
    ...
    colorRibbonsAttribute(setParameters, svgRibbons, dimensionName) {
    ...
    moveParSetsDimensionLabels(svgDimensions) {
...
//# sourceMappingURL=ParallelSets.js.map