export class BaseUtils {
     ...
     */
    static removeMissingValues(arr1, arr2) {
        const filtered1 = [];
        const filtered2 = [];
     ...
     */
    static measureResultObj(scoreVal, pVal, setSizeA, setSizeB, addData) {
