...
import { Comparison, SCOPE, Type } from '../base/interfaces';
...
export class ASimilarityMeasure {
    pValueAvailability(original, valid, threshold = 0.1) {
...
// =================================================================
// =================================================================
let ChiSquareTest = class ChiSquareTest extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'chi2_test';
 ...
 */
let JaccardSimilarity = class JaccardSimilarity extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'jaccard';
    ...
    async calc_Randomize(setA, setB, allData) {
        return new JaccardRandomizationWorker().calculate({ setA, setB, allData });
    }
};
JaccardSimilarity = __decorate([
    MeasureDecorator()
], JaccardSimilarity);
export { JaccardSimilarity };
let ChiSquareIndependenceTest = class ChiSquareIndependenceTest extends ChiSquareTest {
    constructor() {
        super();
    ...
    async calc(arrA, arrB) {
        ...
        for (const catA of setACategories) { // contingency table rows
            for (const catB of setBCategories) { // contingency table columns
                const indices = [];
                const amountCatA = arrA.filter((val, index) => {
...
ChiSquareIndependenceTest = __decorate([
    MeasureDecorator()
], ChiSquareIndependenceTest);
export { ChiSquareIndependenceTest };
/**
 * Also known as the Tanimoto distance metric.
 */
let AdjustedRandIndex = class AdjustedRandIndex extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'adjrand';
...
// =================================================================
// =================================================================
let WilcoxonRankSumTest = class WilcoxonRankSumTest extends ASimilarityMeasure {
    constructor() {
        super();
    ...
    async calc(setA, setB) {
        ...
        const selectionRankObj = setAValid.map((a) => {
            return {
                set: 'selection',
                value: a
            };
...
WilcoxonRankSumTest = __decorate([
    MeasureDecorator()
], WilcoxonRankSumTest);
export { WilcoxonRankSumTest };
/**
 * MannWhitneyUTest === WilcoxonRankSumTest, therefore this class is just a rename
 */
let MannWhitneyUTest = class MannWhitneyUTest extends WilcoxonRankSumTest {
    constructor() {
        super();
        this.id = 'mwu_test';
...
MannWhitneyUTest = __decorate([
    MeasureDecorator()
], MannWhitneyUTest);
export { MannWhitneyUTest };
let StudentTTest = class StudentTTest extends ASimilarityMeasure {
    constructor() {
        super();
...
StudentTTest = __decorate([
    MeasureDecorator()
], StudentTTest);
export { StudentTTest };
let SpearmanCorrelation = class SpearmanCorrelation extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'spearmanCor';
...
SpearmanCorrelation = __decorate([
    MeasureDecorator()
], SpearmanCorrelation);
export { SpearmanCorrelation };
let PearsonCorrelation = class PearsonCorrelation extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'pearsonCor';
...
// =================================================================
// =================================================================
let EnrichmentScore = class EnrichmentScore extends ASimilarityMeasure {
    constructor() {
        super();
        this.id = 'enrichment';
    ...
    async calcPValuePermutation(numericSet, categorySet, actualScores) {
    ...
    calcEnrichmentScoreCategory(setCombined, currCategory, amountCategory) {
