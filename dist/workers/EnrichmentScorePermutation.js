...
function calc(setNumber, setCategory) {
...
function calcEnrichmentScoreCategory(setCombined, currCategory, amountCategory) {
...
ctx.onmessage = (event) => {
    try {
        const setNumber = event.data.setNumber;
        const setCategory = event.data.setCategory;
        const actualScores = event.data.actualScores;
...
//# sourceMappingURL=EnrichmentScorePermutation.js.map